...
with tf.compat.v1.variable_scope('model', reuse=True):
    env.adv_epochs = tf.compat.v1.placeholder(tf.int32, (), name='adv_epochs')
...
def train(sess, env, X_data, y_data, X_valid=None, y_valid=None, epochs=1,
    ...
    #     print('\n Saving model')
    #     os.makedirs('/Users/halisha/miniconda3/envs/dimploma/model', exist_ok=True)
...
plt.savefig('/Users/halisha/miniconda3/envs/dimploma/img/deepfool_mnist.png')
